            ...
            <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-8'>
                <div className='md:w-11/12 mx-auto flex flex-col md:flex-row justify-between items-center gap-12'>
                    ...
                    <div className='md:w-3/5 mx-auto'>
                        ...
                        <p className='md:w-3/4 text-sm text-neutralGrey mb-8'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quaerat excepturi tempore nam, error dolores architecto eligendi atque saepe, repellat necessitatibus temporibus, cum nulla repellendus sunt. Sapiente excepturi odio quam perferendis.</p>
